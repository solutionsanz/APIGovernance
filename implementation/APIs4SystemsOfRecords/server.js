...
var db = monk(MONGODB_CREDENTIALS + config.MONGODB_SERVER + ':' + config.MONGODB_PORT + '/api4sysrecords');

// Converting YAML into JSON for Swagger UI loading purposes:
var inputfile = 'anki-sysrecords.yml',
    outputfile = 'anki-sysrecords.json';
